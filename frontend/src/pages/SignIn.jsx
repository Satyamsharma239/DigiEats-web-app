    ...
    const handleGoogleAuth = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(`${serverUrl}/api/auth/google-auth`, {
                ...
                role: "user",
                mobile: "9999999999" // Default mobile or handled differently based on exact previous logic
            }, { withCredentials: true })
    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
                ...
                <p className='text-gray-600 mb-8'> Welcome back! Sign in to get your delicious food delivered.</p>
                ...
                <div className='flex justify-end mb-4'>
                    <p className='text-sm text-gray-500 cursor-pointer hover:underline' onClick={() => navigate("/forgot-password")}>Forgot Password?</p>
                </div>
