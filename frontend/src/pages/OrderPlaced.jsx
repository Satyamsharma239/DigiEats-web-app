...
function OrderPlaced() {
  ...
  return (
    <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
      ...
      <button className='bg-[#e23744] hover:bg-[#cb202d] text-white px-6 py-3 rounded-lg text-lg font-medium shadow-md hover:shadow-lg transition-all active:scale-95' onClick={() => navigate("/my-orders")}>Back to my orders</button>
    </div>
  )
}
