...
|:---:|:---:|
| ![Shop Management](screenshots/admin_shops.png) | ![Orders Management](screenshots/admin_orders.png) |

| Reports & Analytics | Settings |
|:---:|:---:|
| ![Reports](screenshots/admin_reports.png) | ![Settings](screenshots/admin_settings.png) |
...
|:---:|:---:|
| ![Customer Home](screenshots/customer_home.png) | ![Cart View](screenshots/customer_cart.png) |

| Shop Details & Menu | Order History |
|:---:|:---:|
| ![Shop View](screenshots/customer_shop_view.png) | ![My Orders](screenshots/customer_orders.png) |
...
└── screenshots/    # Project module walkthrough screens
```
